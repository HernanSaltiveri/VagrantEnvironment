...
docker run -d --rm --name redis-0 --net redis -v ${PWD}/redis-0:/etc/redis/ -v redis:/data/ redis:6.0-alpine redis-server /etc/redis/redis.conf

docker run -d --rm --name redis-1 --net redis -v ${PWD}/redis-1:/etc/redis/ -v redis:/data/ redis:6.0-alpine redis-server /etc/redis/redis.conf

docker run -d --rm --name redis-2 --net redis -v ${PWD}/redis-2:/etc/redis/ -v redis:/data/ redis:6.0-alpine redis-server /etc/redis/redis.conf
